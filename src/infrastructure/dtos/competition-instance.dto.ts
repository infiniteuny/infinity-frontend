...
export class CompetitionInstanceMapper {
  public static fromDomainToDto(
    ...
    return {
      ...
      start_date: competitionInstance.startDate?.toISOString().split('T')[0],
      end_date: competitionInstance.endDate?.toISOString().split('T')[0],
  ...
  public static fromDtoToDomain(dto: CompetitionInstanceDto): CompetitionInstance {
    return new CompetitionInstance(
      ...
      dto.logo,
      DateTime.fromISO(dto.start_date, { zone: 'UTC' }).toJSDate(),
      DateTime.fromISO(dto.end_date, { zone: 'UTC' }).toJSDate(),
      dto.location,
