...
export type UpdateCompetitionInstanceParams = [
  id: string,
...
@injectable()
export class UpdateCompetitionInstance implements UseCase<
  Promise<Either<CompetitionInstance, Error>>,
  UpdateCompetitionInstanceParams
> {
  ...
  public async execute(
    ...
    if (isRight(accessTokenResult)) {
      return await this.competitionInstanceRepository.updateCompetitionInstance(
        id,
        competitionInstance,
        abortSignal,
