...
export type DeleteCompetitionRankParams = [id: string, abortSignal?: AbortSignal];

@injectable()
export class DeleteCompetitionRank implements UseCase<
  Promise<Either<CompetitionRank, Error>>,
  DeleteCompetitionRankParams
> {
  ...
  public async execute(
    ...
    if (isRight(accessTokenResult)) {
      return await this.competitionRankRepository.deleteCompetitionRank(
        id,
        abortSignal,
