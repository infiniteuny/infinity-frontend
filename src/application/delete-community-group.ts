...
export type DeleteCommunityGroupParams = [id: string, abortSignal?: AbortSignal];

@injectable()
export class DeleteCommunityGroup implements UseCase<
  Promise<Either<CommunityGroup, Error>>,
  DeleteCommunityGroupParams
> {
  ...
  public async execute(
    ...
    if (isRight(accessTokenResult)) {
      return await this.communityGroupRepository.deleteCommunityGroup(
        id,
        abortSignal,
