...
export type GetCommunityGroupParams = [
  id: string,
...
@injectable()
export class GetCommunityGroup implements UseCase<
...
> {
  ...
  public async execute(
    ...
    return await this.communityGroupRepository.getCommunityGroup(id, abortSignal, accessToken);
  }
}
