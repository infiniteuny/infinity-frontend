...
export function AllowExpiredReregistrationTile({ initialValue }: Props) {
  const key = 'allow_expired_reregistration';
  ...
  return (
    <Container
      ...
      className={`inline-flex w-full justify-start rounded-md p-4 text-left select-text`}
    >
      <Box className="flex-1">
        <Typography variant="body1" component="p" className="font-medium">
          Allow expired re-registration
        </Typography>
        <Typography variant="body2" component="p">
          Show the extension menu to users with expired memberships
        </Typography>
      </Box>
