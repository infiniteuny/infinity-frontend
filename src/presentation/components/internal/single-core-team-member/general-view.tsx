...
export function GeneralView({ coreTeamMember }: Props) {
  return (
      ...
      <Container maxWidth={false} className="max-w-2xl p-0">
        ...
        <Grid container spacing={0.5}>
          ...
          <Grid size={12}>
            <ViewTile
              title="Division"
              subtitle={coreTeamMember.membership.coreTeamDivision?.name ?? 'N/A'}
              position="middle"
            />
          </Grid>
          <Grid size={12}>
              ...
              >
                <Box className="flex flex-row items-center justify-between gap-2">
                  ...
                  <Stack direction="row" spacing={1}>
                    {typeof coreTeamMember.membership.photo === 'string' ? (
                      <>
                        <IconButton
                          component="a"
                          LinkComponent={Link}
                          href={coreTeamMember.membership.photo}
                          download="photo.jpg"
                          target="_blank"
          ...
          {coreTeamMember.membership.animation ? (
            <Grid size={12}>
              <Container
                maxWidth={false}
                sx={{ bgcolor: 'surfaceContainerHigh.main' }}
              ...
              >
                ...
                >
                  <Box className="flex flex-row items-center justify-between gap-2">
                    ...
                    <Stack direction="row" spacing={1}>
                      {typeof coreTeamMember.membership.animation === 'string' ? (
                        <>
                          <IconButton
                            component="a"
                            LinkComponent={Link}
                            href={coreTeamMember.membership.animation}
