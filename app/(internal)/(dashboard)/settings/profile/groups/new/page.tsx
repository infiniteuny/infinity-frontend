...
export default async function ProfileGroupNewPage() {
    ...
    return (
      <InternalMain
        breadcrumbs={[
          ...
          { label: 'Add', url: '/settings/profile/groups/new' },
        ]}
      >
        <UserGroupForm user={UserMapper.fromDomainToDto(user) as UserDto} isProfileForm />
      </InternalMain>
    );
  } else {
    notFound();
